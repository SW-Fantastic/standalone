...
Java_org_swdc_extern_ice_RegistryKey_connectRegistry
...
JNIEXPORT jobject JNICALL
Java_org_swdc_extern_ice_RegistryKey_openSubKey
...
JNIEXPORT jobject JNICALL
Java_org_swdc_extern_ice_RegistryKey_createSubKey
...
Java_org_swdc_extern_ice_RegistryKey_closeKey
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT void JNICALL
Java_org_swdc_extern_ice_RegistryKey_deleteValue
...
JNIEXPORT void JNICALL
Java_org_swdc_extern_ice_RegistryKey_deleteSubKey
...
JNIEXPORT void JNICALL
Java_org_swdc_extern_ice_RegistryKey_flushKey
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
Java_org_swdc_extern_ice_RegistryKey_getStringValue
		( JNIEnv *env, jobject rkObject, jstring valueName )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jstring JNICALL
Java_org_swdc_extern_ice_RegistryKey_getDefaultValue
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
Java_org_swdc_extern_ice_RegistryKey_hasDefaultValue
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jboolean JNICALL
Java_org_swdc_extern_ice_RegistryKey_hasOnlyDefaultValue
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT void JNICALL
Java_org_swdc_extern_ice_RegistryKey_setValue
		( JNIEnv *env, jobject rkObject,
...
Java_org_swdc_extern_ice_RegistryKey_getNumberSubkeys
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_getMaxSubkeyLength
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jstring JNICALL
Java_org_swdc_extern_ice_RegistryKey_regEnumKey
...
JNIEXPORT jstring JNICALL
Java_org_swdc_extern_ice_RegistryKey_regEnumValue
		( JNIEnv *env, jobject rkObject, jint index )
	{
	HKEY		hKey;
	jstring		result = NULL;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_getNumberValues
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_getMaxValueDataLength
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_getMaxValueNameLength
		( JNIEnv *env, jobject rkObject )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_incrDoubleWord
		( JNIEnv *env, jobject rkObject, jstring valueName )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jint JNICALL
Java_org_swdc_extern_ice_RegistryKey_decrDoubleWord
		( JNIEnv *env, jobject rkObject, jstring valueName )
	{
	HKEY		hKey;
	LONG		regErr;
...
JNIEXPORT jobject JNICALL
Java_org_swdc_extern_ice_RegistryKey_getValue
		( JNIEnv *env, jobject rkObject, jstring valueName )
	{
	HKEY		hKey;
	LONG		regErr;
	...
	switch ( type )
		...
		case REG_SZ:
		case REG_EXPAND_SZ:
			className = "org/swdc/extern/ice/RegStringValue";
			methodSignature = "(Ljava/lang/String;)V";
			break;

		case REG_MULTI_SZ:
			className = "org/swdc/extern/ice/RegMultiStringValue";
			methodSignature = "([Ljava/lang/String;)V";
			break;

		case REG_DWORD:
		case REG_DWORD_BIG_ENDIAN:
			className = "org/swdc/extern/ice/RegDWordValue";
			methodSignature = "(I)V";
			break;

		case REG_BINARY:
			className = "org/swdc/extern/ice/RegBinaryValue";
			methodSignature = "([B)V";
			break;
		}
...
JNIEXPORT jstring JNICALL
Java_org_swdc_extern_ice_RegistryKey_expandEnvStrings
...
newRegistryKey( JNIEnv *env, HKEY hKey, jstring keyName, BOOL created )
	...
	char		*className = "org/swdc/extern/ice/RegistryKey";
...
newRegistryValue(
	...
	char		*methodName = "<init>";
	char		*methodSignature =
		"(Lorg/swdc/extern/ice/RegistryKey;Ljava/lang/String;I)V";
...
throwNoSuchKeyException( JNIEnv *env, char *message )
	...
	jclass		exClass;
	char		*className =
		"org/swdc/extern/ice/NoSuchKeyException";
...
throwNoSuchValueException( JNIEnv *env, char *message )
	...
	jclass		exClass;
	char		*className =
		"org/swdc/extern/ice/NoSuchValueException";
...
throwRegErrorException( JNIEnv *env, LONG regErr, char *message )
	...
	char		strBuf[512];
	char		*regDescription = "";
	char		*className = "org/swdc/extern/ice/RegistryException";
