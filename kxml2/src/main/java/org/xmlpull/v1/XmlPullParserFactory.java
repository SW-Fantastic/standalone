...
public class XmlPullParserFactory {
    ...
    final static Module referenceContext;

    static {
        XmlPullParserFactory f = new XmlPullParserFactory();
        referenceContext = f.getClass().getModule();
    }
    ...
    public static XmlPullParserFactory newInstance (String classNames, Module context)
